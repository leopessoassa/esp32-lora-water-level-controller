...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<HttpErrorResponse> handleException(Exception e) {
    ...
    var response = HttpErrorResponse.of(e.getMessage(), 500);
    return new ResponseEntity<>(response, HttpStatus.INTERNAL_SERVER_ERROR);
  }

  @org.springframework.web.bind.annotation.ExceptionHandler(QueryParameterException.class)
  public ResponseEntity<HttpErrorResponse> handleException(QueryParameterException e) {
    log.info("Handling QueryParameterException: {}", e.getMessage());
    var response = HttpErrorResponse.of( e.getMessage(), 422);
    return new ResponseEntity<>(response, HttpStatus.UNPROCESSABLE_ENTITY);
  }
}
