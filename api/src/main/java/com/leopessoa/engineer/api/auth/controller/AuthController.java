package com.leopessoa.engineer.api.auth.controller;

import com.leopessoa.engineer.api.auth.data.LoginRequest;
import com.leopessoa.engineer.api.auth.service.AuthService;
...
public class AuthController {
  ...
  @PostMapping("/login")
  public ResponseEntity<?> login(HttpServletRequest request, HttpServletResponse response, @Valid @RequestBody LoginRequest body) {
