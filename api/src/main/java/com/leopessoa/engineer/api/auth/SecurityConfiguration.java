    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(customizer -> {
            customizer
                    ...
                    .requestMatchers(antMatcher(HttpMethod.GET, "/api/water-levels/sensor-create")).permitAll()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/api/cisterns/find/**")).permitAll()
                    //.requestMatchers(antMatcher(HttpMethod.GET, "/api/sumary/last-measurement/**")).permitAll()
                    //.requestMatchers(antMatcher(HttpMethod.GET, "/api/sumary/by-month/**")).permitAll()
                    //.requestMatchers(antMatcher(HttpMethod.GET, "/api/sumary/by-date/**")).permitAll()
                    //.requestMatchers(antMatcher(HttpMethod.GET, "/api/sumary/last/**")).permitAll()
                    .requestMatchers(antMatcher(HttpMethod.GET, "/api/sumaries/**")).permitAll()
