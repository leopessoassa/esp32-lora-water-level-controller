...
import com.leopessoa.engineer.api.util.ApplicationContextProvider;
...
public class User extends AbstractEntity implements UserDetails {
    ...
    private final List<UserConnectedAccount> connectedAccounts = new ArrayList<>();
    ...
    public User(CreateUserRequest data) {
        ...
        this.role = data.getRole() != null ? data.getRole() : Role.USER;
    }
